...
export const createCatalog=(assets:Asset[],mode:Mode):Catalog=>({version:'1.0',generatedAt:new Date().toISOString(),settings:{geometryMode:mode,coordinateSystem:'normalized',orthogonalOnly:true},assets});
