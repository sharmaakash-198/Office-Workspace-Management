...
export type Status = 'AUTO_EXACT' | 'AUTO_BOUNDS' | 'AUTO_ORTHOGONAL' | 'REVIEW_REQUIRED' | 'FAILED';
export interface Asset { id: string; source: string; label?: string; geometry?: Geometry; metadata: { automatic: boolean; status: Status; reason?: string; bounds?: Bounds } }
