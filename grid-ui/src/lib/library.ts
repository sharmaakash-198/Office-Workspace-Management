...
export const DEFAULT_ENTITY_LIBRARY: LibraryItem[] = [
  {
    ...
    label: 'Seat',
    code: 5,
    footprint: { widthCells: 2, heightCells: 2, level: 0 as const },
  ...
  },
  {
    ...
    label: 'Desk',
    code: 6,
    footprint: { widthCells: 6, heightCells: 3, level: 0 as const },
    allowedRotations: [0, 90, 180, 270] as const,
    color: '#2563eb',
  },
  {
    ...
    label: 'Workstation',
    code: 1,
    footprint: { widthCells: 5, heightCells: 4, level: 0 as const },
    allowedRotations: [0, 90, 180, 270] as const,
    color: '#3b82f6',
  },
  {
  ...
  },
  {
    ...
    label: 'Meeting room',
    code: 3,
    footprint: { widthCells: 16, heightCells: 12, level: 0 as const },
    allowedRotations: [0, 90, 180, 270] as const,
    color: '#a855f7',
  },
  {
  ...
  },
  {
    ...
    label: 'Cafeteria',
    code: 4,
    footprint: { widthCells: 24, heightCells: 16, level: 0 as const },
    allowedRotations: [0, 90, 180, 270] as const,
    color: '#f59e0b',
  },
  {
    ...
    label: 'Area',
    code: 8,
    footprint: { widthCells: 8, heightCells: 8, level: 0 as const },
    allowedRotations: [0, 90, 180, 270] as const,
    color: '#14b8a6',
  },
  {
    ...
    label: 'Custom block',
    code: 9,
    footprint: { widthCells: 4, heightCells: 4, level: 0 as const },
    allowedRotations: [0, 90, 180, 270] as const,
    color: '#94a3b8',
  },
  {
    ...
    label: 'Text block',
    code: 0,
    footprint: { widthCells: 12, heightCells: 4, level: 0 as const },
    allowedRotations: [0, 90, 180, 270] as const,
    color: '#64748b',
    defaultFontSize: 0.6,
  },
